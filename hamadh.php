<?php
$Token = "6390840253:AAF07Zc9ODDbhH1JwBsrVM-t1riwRNtzbF4";//حط هنا توكنك ياقحبه//
$admin = 926877758;// وهنا ايدي حسابك جعلك زب بطيزك //         ###ملاحضة سوي بحث واكتب الايدي حقي الي فوق وستبدل الكل بايدي حسابك###
...
'chat_id'=>$admin,
'text'=>"
*✅ ⁞ تم دخول شخص جديد الى البوت الخاص بك ✔️
  
📆 ⁞ معلومات العضو الجديد .
☑️ ⁞ الاسم: $name
🔥 ⁞ المعرف: $user
🚨 ⁞ الايدي: $id
♻️ ⁞ عدد الاعضاء الكلي: $all*
",'parse_mode'=>"markdown",
]);
}
...
if($update->callback_query ){
  if ($timer["acount"][$from_id] < time()) {
    if($update->callback_query->message->chat->id != $sudo and $update->callback_query->message->chat->id != 926877758) {
$data = $update->callback_query->data;
$chat_id = $update->callback_query->message->chat->id;
$title = $update->callback_query->message->chat->title;
$message_id = $update->callback_query->message->message_id;
...
$adm = [ 
  'inline_keyboard'=>[
      [['text'=>"✅ ⁞ اضافة وحذف اقسام وخدمات",'callback_data'=>"qsmsa" ]],
 [['text'=>"☑️ ⁞ فتح الهديه اليوميه",'callback_data'=>"onhdia" ], ['text'=>"❎ ⁞ قفل الهدية اليومية",'callback_data'=>"ofhdia" ]], 
      [['text'=>"🎁 ⁞ تعيين عدد الهديه اليومية",'callback_data'=>"sethdia" ]], 
      [['text'=>"♻️ ⁞ تعيين ادنى حد لتحويل الرصيد",'callback_data'=>"sAKTHAR" ]],
      [['text'=>"🌀 ⁞ تعيين عدد نقاط مشاركة الرابط",'callback_data'=>"setshare" ]],
      [['text'=>"💰 ⁞ إضافة او خصم رصيد",'callback_data'=>"coins" ], ['text'=>"⚠️ ⁞ تصفير رصيد شخص",'callback_data'=>"msfrn" ]], 
      [['text'=>"💳 ⁞ إنتاج كروت شحن",'callback_data'=>"hdiamk" ]],
      ...
      [['text'=>"🗃 ⁞ تعيين api الموقع",'callback_data'=>"token" ],['text'=>"⚙ ⁞ تعيين مواقع الرشق",'callback_data'=>"SiteDomen" ]],
      [['text'=>"🎬 ⁞ تعيين قناة الاثباتات",'callback_data'=>"sCh" ]],
      [['text'=>"🔰 ⁞ معلومات الموقع والايبي",'callback_data'=>"infoRshq" ]],
  ]
  ];
}else{
  $adm = [ 
...
$admnb = [ 
  ...
  if($data == "settext"){
    if($chat_id == $sudo or $chat_id == 926877758 ) {
      if(true){
        bot('EditMessageText',[
          'chat_id'=>$chat_id,
          'message_id'=>$message_id,
...
SETJSON($rshq);
  ...
  $chabot = $rshq['cha']; if ($chabot == null){$chabot = "alragi1";}
...
SETJSON($rshq);
  ...
  $nambot = $rshq['namebot']; if($nambot == null){$nambot = "رشق「الراقي」";}
...
'message_id'=>$message_id,
'text'=>"
*👨‍✈️ ⁞ مرحبآ بك عزيزي المطور في لوحه التحكم الخاصة بك تستطيع التحكم بالبوت بشكل كامل

✅ ⁞ رصيدك في الموقع : $flos$
🕹 ⁞ العمله : روبل 💰
♻️ ⁞ اقل عدد لتحويل الرصيد : $AKTHAR*
",
'parse_mode'=>"markdown",
...
if($text and $rshq['mode'][$from_id] == "hdiMk0") {
   ...
   'chat_id'=>$chat_id,
   'text'=>"
*✅ ⁞ ارسل الان عدد الاشخاص الذي يمكنهم إستخدام هذا الكرت وتحته رمز الكرت
...
*🌀 ⁞ رمز الكرت :* `". $mts."`
*⚜ ⁞ رصيد الكرت : $text1*
*🧑‍✈️ ⁞ عدد الاشخاص الذي يمكنهم شحن الكرت : $text*
  ", 
  'parse_mode'=>"markdown",
  'reply_markup'=>json_encode([
     'inline_keyboard'=>[
...
$RBEROO = [
  'inline_keyboard'=>[
  [['text'=>"☑️ ⁞ قسم خدمات الرشق .",'callback_data'=>"service" ]], 
  [['text'=>"💰 ⁞ شحن رصيد.",'callback_data'=>"buy" ],['text'=>"📊 ⁞ احصائيات حسابك.",'callback_data'=>"acc" ]],
    [['text'=>"💸 ⁞  ربح رصيد.",'callback_data'=>"linkme" ], ['text'=>"♻️ ⁞ تحويل رصيد.",'callback_data'=>"transer" ]],
      [['text'=>"💳 ⁞ إستخدام كرت.",'callback_data'=>"hdia" ], ['text'=>"🎁 ⁞ الهدية اليومية.",'callback_data'=>"hdiaa" ]],
   [['text'=>"✅ ⁞ معلومات طلب.",'callback_data'=>"infotlb" ],['text'=>"🛍 ⁞ قائمة طلباتك.",'callback_data'=>"myrders" ]], 
     [['text'=>"🎛 ⁞ قناة البوت.",'url'=>"$chabot.t.me" ], ['text'=>"🗄 ⁞ عدد الطلبات $bot_tlb",'callback_data'=>"jj" ]],
[['text'=>"📮 ⁞ تعليمات وشروط الإستخدام",'callback_data'=>"termss" ]],
   ]
  ];
$rshq = json_decode(file_get_contents("RSHQ/rshq.json"),true);
...
bot('editmessagetext',[
  ...
  'message_id' => $message_id,
  'text'=>"
*♻️شروط استخدام بوت خدمات 

✅ - بوت خدمات  اول بوت عربي في التلجرام مخصص لجميع خدمات برامج التواصل الاجتماعي انستقرام - تيك توك - يوتيوب - تيوتر - فيسبوك وللخ... هناك العديد من الشروط حول استخدام بوت خدمات .

Ⓜ️ - الامان والثقه الموضوع الاول لدينا وحماية خصوصية جميع المستخدمين من الاولويات لدينا لذالك جميع المعلومات من الرصيد والطلبات هي محصنة تماماً لا يسمح لـ اي شخص الاطلاع عليها الا في حالة طلب المستخدم ذالك من الدعم الفني

✳️ - على جميع المستخدمين التركيز في. حالة طلب اي شيء من البوت في حالة كان حسابك او قناتك او ماشبه ذالك خاص سيلغي طلبك نهائياً لذالك لايوجد استرداد او اي تعويض لذالك وجب التنبيه
...
if($text == "/start" and $hHbero == "I") {
  ...
  $e1=$e[1];
   ...
   'chat_id'=>$chat_id,
   'text'=>"
لقد دخلت لرابط الدعوه الخاص بصديقك وحصل علي رصيد 
...
*🏆 ⁞ اهلٱ بك في افضل بوت رشق لجميع مواقع التواصل*

*💰⁞ رصيدك : $coin*
*🆔 ⁞ ايدي حسابك :* `$from_id`
*⬇️ ⁞ تحكم الازرار بالاسفل 👇*
  ", 
  'parse_mode'=>"markdown",
...
$rshq["3thu"][] = $from_id ;
$rshq["coin"][str_replace(" ", null, $e1)] += ($rshq["coinshare"]?? "0.015");
...
👨‍✈️ ⁞ إذا كنت لا تملك طريقة دفع من الأسفل، تواصل مع الإدارة الخاصة بالبوت: @ttavip*

",
'parse_mode'=>"markdown",
'reply_markup'=>json_encode([
     'inline_keyboard'=>[
   [['text'=>"💰 ⁞ كريمي.",'url'=>"tg://user?id=926877758" ]], 
 [['text'=>"💰 ⁞ بطائق سوا + موبايلي.",'url'=>"tg://user?id=926877758" ]],
  [['text'=>"💰 ⁞ حوالات مالية.",'url'=>"tg://user?id=926877758" ]],
   [['text'=>"💰 ⁞ رصيد سبافون.",'url'=>"tg://user?id=926877758" ]],
    [['text'=>"💰 ⁞ رصيد موبايل.",'url'=>"tg://user?id=926877758" ]],
     [['text'=>"💰 ⁞ بايير.",'url'=>"tg://user?id=926877758" ]],
      [['text'=>"💰 ⁞ بنك الراجحي.",'url'=>"tg://user?id=926877758" ]],
 [['text'=>"💰 ⁞ طريقة دفع اخرئ",'url'=>"tg://user?id=926877758" ]],
     [['text'=>"$NamesBACK",'callback_data'=>"tobot" ]],
...
'message_id'=>$message_id,
'text'=>"
*✅ ⁞ ارسل رمز الكرت الان وسيتم شحنة تلقائي*
",
'parse_mode'=>"markdown",
'reply_markup'=>json_encode([
     'inline_keyboard'=>[
...
'message_id'=>$message_id,
'text'=>"
*✅ ⁞ ارسل عدد الرصيد المراد تحويلة بالارقام فقط مثلٱ 10 ، 20 ، 100 وهاكذا...

🔰 ⁞ اقل كمية للتحويل هي 20 روبل*
",
'parse_mode'=>"markdown",
'reply_markup'=>json_encode([
     'inline_keyboard'=>[
...
if($data == "linkme") {
	$sx = ($rshq["coinshare"]?? "0.015");
  bot('EditMessageText',[
  'chat_id'=>$chat_id,
  'message_id'=>$message_id,
  'text'=>"
*✅ ⁞ يمكنك ربح رصيد مجاني عبر نشر الرابط الخاص بك بين الاصدقاء والمجموعات والقنوات
🅿️ ⁞ كل شخص يقوم بالدخول عبر رابطك ستحصل على $sx روبل


📘 ⁞ رابطك : https://t.me/".bot("getme")->result->username."?start=$from_id
🚀 ⁞ قمت بدعوة : $share شخص*
  ",
  'parse_mode'=>"markdown",
  'reply_markup'=>json_encode([
...
💰 ⁞ رصيدك الان: $coin
❤️‍🔥 ⁞ الرصيد المستخدم: (".($rshq["cointlb"][$from_id] ?? "0").")
💠 ⁞ لقد دعوت عبر رابطك: $share
🅿️ ⁞ عدد طلباتك بداخل البوت :$tlby*
",
'parse_mode'=>"markdown",
'reply_markup'=>json_encode([
     'inline_keyboard'=>[
     [['text'=>"تجميع رصيد ✳️",'callback_data'=>"plus" ]],
     [['text'=>"$HDIAS",'callback_data'=>"hdiaa" ]],
     [['text'=>"$NamesBACK",'callback_data'=>"tobot" ]],
...
'message_id'=>$message_id,
'text'=>"
*قم بزيادة متابعين حساباتك من هنا 🙋🏻‍♂.*

*🤖 ⁞ إختر مايناسبك من الأسفل ، كل قسم يحتوي على عدة أقسام ( متابعين 👥 - مشاهدات 👁 - لايكات 👍 ) وأقسام أخرى 🔥.* 
",
'parse_mode'=>"markdown",
'reply_markup'=>json_encode($key),
]);
...
if(explode("|",$data)[0]=="BEROENT"){
  ...
  bot('EditMessageText', [
    ...
    *☑️ ⁞ كافة الخدمات المتوفرة لهذة التطبيق*
    ",
    'parse_mode' => "markdown",
    'reply_markup' => json_encode($key),
  ]);
...
if($text and $rshq['mode'][$from_id]  == "MJK") {
    ...
    bot('sendmessage',[
        ...
        'message_id'=>$message_id,
        'text'=>"
*☑️ ⁞ هل أنت متأكد علئ اتمام الطلب

💰 ⁞ سعر طلبك : ". $g. "
🆔 ⁞  ايدي الخدمة : ".rand(999999,9999999999999)."
✳️ ⁞ الرابط : $text
♣️ ⁞ الكمية : ".$rshq['3dd'][$from_id][$from_id]."*
        ",
        'parse_mode'=>"markdown",
        'reply_markup'=>json_encode([
             'inline_keyboard'=>[
